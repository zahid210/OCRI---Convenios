...
export default function DependenciasPage() {
    ...
    const [formKind, setFormKind] = useState<'RECTORADO' | 'OCRI' | 'UNIDAD_ORGANICA'>('UNIDAD_ORGANICA');
    ...
    const loadData = useCallback(async () => {
        try {
            const params = activeSearch ? `?search=${encodeURIComponent(activeSearch)}` : '';
                        ...
                        <table className="w-full text-left border-collapse">
                            ...
                            {data.map((dep) => (
                                ...
                                >
                                    ...
                                    <td className="py-4">
                                        <span className={`inline-flex items-center px-2.5 py-1 text-xs border ${KIND_CLASSES[dep.kind] || 'bg-gray-50 text-gray-700 border-gray-200'}`}>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
                    <div className="bg-white border border-gray-200 shadow-xl max-w-lg w-full mx-4">
                        ...
                        <div className="p-6 grid grid-cols-2 gap-4">
                            <div>
                                <label className="block text-xs font-semibold uppercase text-gray-500 mb-1">Código</label>
                                <input
                                    value={formCode}
                            ...
                            <div className="col-span-2">
                                <label className="block text-xs font-semibold uppercase text-gray-500 mb-1">Email (opcional)</label>
                                <input
                                    value={formEmail}
                            ...
                            <div>
                                <label className="block text-xs font-semibold uppercase text-gray-500 mb-1">Orden</label>
                                <input
                                    value={formSortOrder}
                            ...
                            <div className="flex items-center gap-2 pt-5">
                                ...
                                />
                                <label htmlFor="is_default_opinion" className="text-sm text-gray-700">
                                    Opinión por defecto
                                </label>
                            </div>
                        </div>
