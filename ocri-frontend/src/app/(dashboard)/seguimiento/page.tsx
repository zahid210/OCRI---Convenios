        ...
        async function loadData() {
            try {
                ...
                if (isMounted) {
                    ...
                    setError(
                        "Ocurrió un error al cargar la etapa de seguimiento.",
                    );
                }
            } finally {
                ...
                <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-2 text-gray-500">
                        <span className="text-xs text-gray-500">
                            Convenios publicados con plan de trabajo e
                            informes en gestión
                        </span>
                    </div>
                </div>
                        ...
                        <tbody className="divide-y divide-gray-100">
                            {loading ? (
                                ...
                                <tr>
                                    ...
                                    >
                                        No se encontraron convenios en etapa de
                                        seguimiento.
                                    </td>
                                </tr>
                            ) : (
                                data?.data.map((row) => {
                                    ...
                                    const planLabel = row.plan_trabajo
                                        ? (DELIVERABLE_STATUS_LABELS[
